...
Where $\pi_a$ and $\pi_p$ represent the probabilities testing positive for COVID-19 in the vaccine and placebo groups, respectively. A common threshold used in clinical trials and FDA approval is $\psi > 0.3$, meaning that the vaccine should reduce the chance of contracting COVID-19 by at least 30% to be considered effective.
